...
class Movies(models.Model):
    ...
    title2 = models.CharField(max_length=500, null=True, blank=True)
    r_date = models.DateField(max_length=500, null=True, blank=True)
    ...
    amount = models.IntegerField(null=True, blank=True, default=250)
